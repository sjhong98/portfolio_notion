export const projectList = [
    { 
      ...
      cap: '대동유어지도는 여행자를 위한 SNS입니다. 여행을 계획하는 과정에서 지역별로 트렌디하고 유용한 정보를 얻을 수 있고, 여행을 다녀온 사람들이 의미 있는 기록을 할 수 있도록 도와줍니다.',
      duration: "23.01-09",
    ...
    },
    {
      title: "대동유어지도 ver.2",
      subtitle: "사진 기반 여행 콘텐츠 SNS 플랫폼",
      main: "#Next13  #SSR  #TS  #Recoil  #RestAPI  #NoSQL",
      duration: "2024.2",
      part: "1인 프로젝트",
      func : ["Firebase NoSQL DB 이용한 포스트 CRUD", "Firebase auth를 통한 인증", ""],
      stack: ["Next.js", "React", "Typescript", "Styled-Components", "Tailwind", "Vercel"],
      dev: ["Next 13 SPA", "Fetch API 이용한 SSR",  "Firebase NoSQL DB 이용한 포스트 CRUD", "Firebase auth 인증", "DB를 통한 회원정보 관리 및 수정(닉네임, 프로필 사진)", "포스트 댓글, 좋아요"],
      cap: "대동유어지도의 기능 및 성능을 개선한 프로젝트입니다. 여행의 계획과 회고를 위한 SNS 서비스입니다.",
      troubles: ['Rest API를 통한 Firestore DB/Auth/Cloud 사용', 'SSR 이용한 성능 개선', '이미지 로딩으로 인한 성능 저하', 'styled-components의 적용 딜레이', '계획 - React Query 적용'],
      solutions: [
        '원래 자체 메소드로 접근해야 하는 Firestore에 Rest API로 접근하고자 함. 이에 공식 문서와 서칭을 통해 방법을 찾고 Rest API로 DB 접근 및 조작 구현',
        'Next 13에서 제공하는 Server Component와 Fetch API를 사용하여 Pre-rendering 단계에서 Data Fetching 수행함으로써 로딩 시간 단축, DB 변화 빠르므로 no-cache 적용',
        'next/image에서 제공하는 Image 태그와 width/height 속성 사용 -> Data Fetching 시 최소화된 이미지 로딩함으로써 로딩 시간 단축',
        '렌더링 시에 적용되는 styled-components 특성으로 인한 CSS 적용 딜레이 해결하고자 함 -> 초기 빌드 시에 적용되어야 하는 CSS에만 tailwind 사용하고, 상호 작용에 따른 CSS는 styled-components 사용.',
        'React Query를 사용하여 Data Fetching과 상태를 함께 관리함으로써 화면에 표시되는 상태와 DB 데이터를 관리하고, 낙관적 적용으로 사용자 경험 향상'
      ],
      image: 1,
      url: 'https://daedongyourmap2.vercel.app/',
      github: 'https://github.com/sjhong98/daedongyourmap2',
      notion: "https://abrupt-soccer-887.notion.site/ver-2-058d7046421845f09fdacb22794fca98?pvs=4",
      etc: ""
    },
    {
      title: "Muse",
    ...
    },
    {
        ...
        cap: "UPMJ는 쉽고 편하게 여행계획을 세울 수 있도록 도와주는 서비스입니다. 관광지 공공데이터를 활용하여 원하는 여행지를 블록으로 만들고, 이를 드래그앤드롭으로 블록 쌓듯 여행 일정을 세울 수 있습니다.",
        duration: "2023.06-07",
