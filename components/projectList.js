export const projectList = [
    ...
    },
    {
      ...
      },
      {
        ...
        solutions: [
            '원래 텍스트 필드로 자유롭게 조작이 가능한 contentEditable를 사용하고자 했으나, contentEditable로 입력된 한글이 두 번씩 중복 저장되는 문제가 발생. 문제 원인을 찾아보았으나, 브라우저 자체 설정과 관련되어 있어 원인 자체의 해결이 불가했고 다만 중복 입력을 무시하는 방법 밖에 없었음. 이를 일부 구현하였으나, 경우의 수를 여러 개로 나누다보니 안정성이 떨어져, textarea를 사용하여 텍스트 필드를 구현하였음.', 
